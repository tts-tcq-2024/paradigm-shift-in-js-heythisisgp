...
function main() {
    ...
    ExpectTrue(batteryIsOk(25, 22, 0.7)); // warning for SOC low
    ExpectTrue(batteryIsOk(25, 78, 0.7)); // warning for SOC high
    ExpectTrue(batteryIsOk(25, 70, 0.78)); //  warning for charge rate high
